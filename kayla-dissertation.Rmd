...
int <-  kayla_processed %>%
  ...
  select(client_number, intaffb, intautb, intaffw, intautw)

# SOST/SOSI PRE
sosp <- kayla_processed %>%
  mutate(sostaffp = (sostcl1p*0) + (sostcl2p*4.5) + (sostcl3p*7.8) + (sostcl4p*4.5) + (sostcl5p*0) + (sostcl6p*-4.5) + (sostcl7p*-7.8) + (sostcl8p*-4.5),
  ...
  select(client_number, sostaffp, sostautp, sosiaffp, sosiautp)
         
# SSOT/SSOI PRE --------------------
ssop <- kayla_processed %>%
  mutate(ssotaffp = (ssotcl1p*0) + (ssotcl2p*4.5) + (ssotcl3p*7.8) + (ssotcl4p*4.5) + (ssotcl5p*0) + (ssotcl6p*-4.5) + (ssotcl7p*-7.8) + (sostcl8p*-4.5),
  ...
  select(client_number, ssotaffp, ssotautp, ssoiaffp, ssoiautp)

# SOST-SOSI AFTER       
sosa <- kayla_processed %>%
  mutate(sostaffa = (sostcl1a*0) + (sostcl2a*4.5) + (sostcl3a*7.8) + (sostcl4a*4.5) + (sostcl5a*0) + (sostcl6a*-4.5) + (sostcl7a*-7.8) + (sostcl8a*-4.5),
  ...
  select(client_number, sostaffa, sostauta, sosiaffa, sosiauta)
         
# SSOT-SOSI AFTER
ssoa <- kayla_processed %>%
  mutate(ssotaffa = (ssotcl1a*0) + (ssotcl2a*4.5) + (ssotcl3a*7.8) + (ssotcl4a*4.5) + (ssotcl5a*0) + (ssotcl6a*-4.5) + (ssotcl7a*-7.8) + (sostcl8a*-4.5),
  ...
  select(client_number, ssotaffa, ssotauta, ssoiaffa, ssoiauta)
...
```{r}
int %>% inner_join(int, sosp, ssop, sosa, ssoa)

bind_cols(int, sosp, ssop, sosa, ssoa) %>% 
