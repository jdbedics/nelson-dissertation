...
panas_data <- kayla_processed %>% dplyr::select(client_number, group, panas1_1, panas1_2, panas2_1, panas2_2)  %>%
...
Empirical Cumulative Distribution Function for Negative (Kayla - you do this one - just like above)
```{r}
